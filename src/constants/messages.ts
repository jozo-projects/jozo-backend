...
export const FNB_SHIFT_COUNT_MESSAGES = {
  ...
  UPDATE_SHIFT_COUNT_DAY_ITEMS_SUCCESS: 'Lưu thông tin nhập thêm/ghi chú kiểm kê FNB thành công',
  LOCK_SHIFT_COUNT_SUCCESS: 'Khóa kiểm kê FNB thành công',
  UNLOCK_SHIFT_COUNT_SUCCESS: 'Mở khóa kiểm kê FNB thành công',
  LIST_SHIFT_COUNTS_SUCCESS: 'Lấy danh sách kiểm kê FNB thành công',
  SHIFT_COUNT_LOCKED: 'Ca kiểm kê đã bị khóa, không thể chỉnh sửa',
  SHIFT_COUNT_ALREADY_LOCKED: 'Ca kiểm kê đã được khóa',
  SHIFT_COUNT_NOT_LOCKED: 'Ca kiểm kê chưa bị khóa',
  ...
  INVALID_STOCK_IN: 'Số lượng nhập thêm phải là số nguyên >= 0',
