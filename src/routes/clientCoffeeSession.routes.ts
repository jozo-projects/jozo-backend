...
} from '~/middlewares/clientCoffeeSession.middleware'
import { wrapRequestHandler } from '~/utils/handlers'

const clientCoffeeSessionRouter = Router()

clientCoffeeSessionRouter.post('/activate', activateCoffeeSessionValidator, wrapRequestHandler(activateCoffeeSessionController))
